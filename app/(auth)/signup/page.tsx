  ...
  async function handleCardanoSignup(asset?: Asset) {
    if (connectedWallet) {
      try {
        ...
        console.error("Failed to handle Cardano signup:", error);
        setMessage({ type: "error", content: "Failed to handle Cardano signup" });
      }
    }
  }
              ...
              <TabsContent value="wallet">
                <div className="space-y-4">
                  ...
                  >
                    ...
                    {isConnected ? "Signup with Wallet" : "Connect Wallet to Signup"}
                  </Button>
