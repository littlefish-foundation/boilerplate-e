...
jest.mock('./asset2page', () => ({
  __esModule: true,
  default: function MockTokenGatedDemoPage() {
    return <div>Token Gated Demo Page 2</div>
  }
}))
...
describe('Asset2 Page Component', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  ...
  it('should set cookie_support_check if it doesn\'t exist', async () => {
    ...
    ;(global.fetch as jest.Mock).mockResolvedValue({
      ...
      json: jest.fn().mockResolvedValue([
        { id: '1', policyID: 'policy1' },
        { id: '2', policyID: 'policy2' }
      ]),
    })

    const result = await Page() as NextResponse<unknown>;
